                    ...
                    <div className="bg-white rounded-2xl sm:rounded-3xl border border-gray-200 shadow-sm hover:shadow-md transition-shadow">
                        <div className="p-4 sm:p-8">
                            <div className="flex items-center gap-3 mb-6 sm:mb-8">
                                <div className="w-8 h-8 sm:w-10 sm:h-10 bg-blue-600 rounded-xl sm:rounded-2xl flex items-center justify-center">
                            ...
                            {pendingSlips.length === 0 ? (
                                <div className="text-center py-12 sm:py-16">
                                    ...
                                    <p className="text-gray-600 text-sm sm:text-base">새로운 허가원이 제출되면 여기에 표시됩니다.</p>
                                </div>
                            ) : (
                                            ...
                                            <div className="flex flex-col lg:flex-row justify-between items-start gap-4">
                                                <div className="flex-1 w-full">
                                                    ...
                                                    {slip.assignedTeacher && (
                                                        <div className="bg-blue-50 border border-blue-200 rounded-xl sm:rounded-2xl p-3 sm:p-5 mb-4 sm:mb-5">
                                                            ...
                                                            <div className="text-blue-700 text-sm sm:text-base font-medium">
                                                ...
                                                <div className="flex flex-col sm:flex-row gap-2 sm:gap-3 w-full lg:w-auto lg:ml-6">
                                                    <button
                                                        ...
                                                        className={`flex-1 lg:flex-none px-4 sm:px-6 py-2 sm:py-3 bg-blue-600 text-white rounded-xl sm:rounded-2xl hover:bg-blue-700 transition-colors font-bold text-sm sm:text-base flex items-center justify-center gap-2 ${processingId === slip.id ? 'opacity-50 cursor-not-allowed' : ''}`}
                        ...
                        <div className="p-4 sm:p-8">
                            ...
                            {todayApprovedSlips.length === 0 ? (
                                <div className="text-center py-12 sm:py-16">
                                    ...
                                    <p className="text-gray-600 text-sm sm:text-base">승인된 허가원이 있으면 여기에 표시됩니다.</p>
                                </div>
                            ) : selectedLocation ? (
                                // 선택된 실의 허가원만 표시
                                <div className="space-y-4 sm:space-y-6">
                                                    ...
                                                    <div className="flex-1 w-full">
                                                        <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-3 mb-4">
                                                            ...
                                                            <div className="flex flex-wrap gap-2">
                                                                ...
                                                                <div className="px-3 py-1 bg-blue-600 text-white rounded-full text-xs sm:text-sm font-medium">
                                                                    승인완료
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        {slip.students && slip.students.length > 0 && (
                                                            <div className="bg-white rounded-xl sm:rounded-2xl p-3 sm:p-5 mb-4 sm:mb-5">
                                                                ...
                                                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-3">
                                                                    {slip.students.map((student, index) => (
                                                                        <div key={index} className="bg-gray-50 border-2 border-gray-200 rounded-xl sm:rounded-2xl p-3 sm:p-4 text-center">
                                                                            <div className="font-bold text-black text-sm sm:text-base">{student.name}</div>
                                                                            <div className="text-xs sm:text-sm text-gray-600 font-medium">{student.studentId}</div>
                                                                        </div>
                                                                    ))}
                                ...
                                <div className="text-center py-12 sm:py-16">
                                    ...
                                    <p className="text-gray-600 text-sm sm:text-base">위의 실별 현황에서 파란색 버튼을 클릭하면 해당 실의 허가원을 확인할 수 있습니다.</p>
                                </div>
                            )}
                        </div>
                    </div>
                ...
                <dialog id="success_modal" className="modal">
                    <div className="modal-box bg-white rounded-2xl sm:rounded-3xl border-2 border-gray-200 shadow-2xl max-w-sm sm:max-w-md mx-4">
                        ...
                        <div className="flex justify-center">
                            <form method="dialog">
                                <button className="px-6 sm:px-8 py-2 sm:py-3 bg-blue-600 text-white rounded-xl sm:rounded-2xl hover:bg-blue-700 transition-colors font-bold text-sm sm:text-base">
                                    확인
                                </button>
                            </form>
                        </div>
